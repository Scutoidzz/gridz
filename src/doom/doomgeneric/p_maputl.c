  ...
  divline_t*	v1 )
{
    ...
    v1x = (long)v1->x/FRACUNIT;
    v1y = (long)v1->y/FRACUNIT;
    v1dx = (long)v1->dx/FRACUNIT;
    v1dy = (long)v1->dy/FRACUNIT;
    v2x = (long)v2->x/FRACUNIT;
    v2y = (long)v2->y/FRACUNIT;
    v2dx = (long)v2->dx/FRACUNIT;
    v2dy = (long)v2->dy/FRACUNIT;
